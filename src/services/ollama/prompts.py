...
class RAGPromptBuilder:
    ...
    def create_rag_prompt(self, query: str, chunks: List[Dict[str, Any]]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            ...
            # Use numbered citations [1], [2], [3] for inline citations
        ...
        prompt += (
            ...
            "IMPORTANT: When referencing information from the papers, use inline citations like [1], [2], [3] "
            "to cite the specific paper chunks above. For example: 'Transformers use attention mechanisms [1] "
            "and have shown superior performance [2].' Use the citation number that matches the chunk number above.\n\n"
        )
