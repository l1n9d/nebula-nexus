...
class MetadataFetcher:
    """Service for fetching papers (arXiv/PubMed) with content processing and database storage."""
    ...
    def __init__(
        ...
        :param arxiv_client: Client for arXiv API operations (optional)
        :param pubmed_client: Client for PubMed API operations (optional)
        ...
        if pdf_cache_dir:
            ...
            self.pdf_cache_dir = arxiv_client.pdf_cache_dir
        elif pubmed_client:
            self.pdf_cache_dir = pubmed_client.pdf_cache_dir
        else:
            self.pdf_cache_dir = Path("./data/pdfs")
