...
# PubMed API exceptions
class PubMedAPIException(Exception):
    """Base exception for PubMed API-related errors."""


class PubMedAPITimeoutError(PubMedAPIException):
    """Exception raised when PubMed API request times out."""


class PubMedAPIRateLimitError(PubMedAPIException):
    """Exception raised when PubMed API rate limit is exceeded."""


class PubMedParseError(PubMedAPIException):
    """Exception raised when PubMed API response parsing fails."""
