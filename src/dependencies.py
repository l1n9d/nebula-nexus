...
def get_search_cache_client(request: Request) -> SearchCacheClient | None:
    """Get search cache client from the request state."""
    return getattr(request.app.state, "search_cache_client", None)
...
SearchCacheDep = Annotated[SearchCacheClient | None, Depends(get_search_cache_client)]
